module Bot
  module Database
    ...
    class Player < Sequel::Model
      ...
      def restock_hand!
        return if 5 == unplayed_cards.count
        (5 - unplayed_cards.count).times do
      ...
      def update_score!
        ...
        game.update(winner: self) if score >= 20
      end
      ...
      def announce_czar
        return unless czar?
        game.text_channel.send_message("**#{discord_user.mention} is the Judge this round... :mega:**")
      end
